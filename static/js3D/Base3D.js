class Base3D {
    draw3D(value) {
        ...
        model.loadModel("js3D/tris.js", function (modeldata) {
            ...
            scene.add(modelcopy) // data to obiekt kontenera zwrócony z Model.j
            modelik.position.y = 10
            camera.position.x = modelcopy.position.x + rozmiar.parameters.width
            camera.position.z = modelcopy.position.z + rozmiar.parameters.width
            camera.position.y = modelcopy.position.y + rozmiar.parameters.width * 1.5
